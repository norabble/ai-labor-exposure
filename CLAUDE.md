...
| `composition_model_signal_over_time.png` | `composition_era_validation.py` | Sector-level Pearson r by YoY period 2005→2025 for four scores including the demand composition model, which carries no technology data at all. Ringed markers are p < 0.05; COVID bands and the 2022 AI boundary marked. Tests whether the demand-type signal is era-invariant. See `docs/charts/composition_model_signal_over_time.md`. |
