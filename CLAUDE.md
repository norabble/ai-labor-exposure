...
| `sector_level_employment_validation.png` | `validate_bls.py` | 2×2 grid: sector mean rebound-adjusted exposure vs. sector employment growth per period. Most informative in 2023→24 (r=−0.412, p=0.057). See `docs/charts/sector_level_employment_validation.md`. |
...
| `dynamic_sector_level_employment_validation.png` | `validate_bls.py` | 2×2 grid: sector mean `net_employment_change` vs. sector employment growth per period. Significant in 2023→24 (r=+0.544, p=0.009), 2024→25 (r=+0.532, p=0.011), and composite. See `docs/charts/dynamic_sector_level_employment_validation.md`. |
